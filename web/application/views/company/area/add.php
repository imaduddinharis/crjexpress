...
<div class="container-fluid mt--8">
    <form method="post" action="<?=base_url()?>office-area/create">
        <div class="row">
            <div class="col-sm-12 mb-4">
                <div class="card card-stats mb-4 mb-lg-0 ">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h3 class="card-title text-uppercase text-default mb-0">Area Information</h3>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-alternative" id="area_name" name="area_name" placeholder="Area Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">          
                                <input type="text" class="form-control form-control-alternative" id="area_description" name="area_description" placeholder="Area Description" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12 mb-4 text-right">
                <button class="btn btn-icon btn-3 btn-primary" type="submit" name="submit">
                    ...
                    <span class="btn-inner--text">Create Office Area</span>
                </button>
            </div>
        </div>
    </form>