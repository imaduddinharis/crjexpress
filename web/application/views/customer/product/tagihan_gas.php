...
<header class="header_area">
  ...
  <section class="section-padding--small bg-gray">
    <div class="container text-center">
      <span class="hero-banner-icon"><i class="fas fa-gas-pump text-danger"></i></span>
      
      <?php if($check == 1):?>
        <p>BILL INFO</p>
      <form method="post" action="<?=base_url()?>feature-crj-express/tagihan-gas/pay" class="form-row mt-3" onsubmit="return confirm('Do you really want to pay?');">
        <center>
      ...
      <?php else:?>
        <p>GAS Number</p>
        <form method="post" action="<?=base_url()?>feature-crj-express/tagihan-gas" class="form-row mt-3">
        <!-- <center> -->
        <div class="col-2"></div>
        <div class="input-group mb-2 col-md-7 col-sm-7 col-12">
            <input type="number" class="form-control" name="phone" placeholder="GAS Number">
        </div>
