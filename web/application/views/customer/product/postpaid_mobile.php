...
<header class="header_area">
  ...
  <section class="section-padding--small bg-gray">
    <div class="container text-center">
      ...
      <?php if($check == 1):?>
        <p>BILL INFO</p>
      <form method="post" action="<?=base_url()?>feature-crj-express/pulsa-pasca-bayar/pay" class="form-row mt-3" onsubmit="return confirm('Do you really want to pay?');">
        <center>
      ...
      <?php else:?>
        <p>PHONE PASCA BAYAR</p>
        <form method="post" action="<?=base_url()?>feature-crj-express/pulsa-pasca-bayar" class="form-row mt-3">
        <!-- <center> -->
        <div class="col-2"></div>
        <div class="input-group mb-2 col-md-7 col-sm-7 col-12">
