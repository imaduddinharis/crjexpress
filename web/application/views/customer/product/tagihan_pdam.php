...
<header class="header_area">
  ...
  <section class="section-padding--small bg-gray">
    <div class="container text-center">
      <span class="hero-banner-icon"><i class="fas fa-water text-danger"></i></span>
      ...
      <?php else:?>
        <p>PDAM NUMBER</p>
        <form method="post" action="<?=base_url()?>feature-crj-express/tagihan-pdam" class="form-row mt-3">
        <!-- <center> -->
        <div class="col-2"></div>
        <div class="input-group mb-2 col-md-4 col-sm-4 col-12">
            <input type="number" class="form-control" name="phone" placeholder="PDAM Number">
        </div>
