...
<header class="header_area">
  ...
  <section class="section-padding--small bg-gray">
    <div class="container text-center">
      ...
      <?php if($check == 1):?>
        <p>BILL INFO</p>
      <form method="post" action="<?=base_url()?>feature-crj-express/tagihan-pdam/pay" class="form-row mt-3" onsubmit="return confirm('Do you really want to pay?');">
        <center>
        ...
        <div class="input-group mb-2 col-md-7 col-sm-7 col-12">
            <p>
                ...
                Contract Number: <?=$trx->data->hp?><br>
                Customer: <?=$trx->data->tr_name?><br>
                Item Name: <?=$trx->data->desc->item_name?><br>
      ...
      <?php else:?>
        <p>Contract Number</p>
        <form method="post" action="<?=base_url()?>feature-crj-express/tagihan-finance" class="form-row mt-3">
        <!-- <center> -->
        <div class="col-2"></div>
        <div class="input-group mb-2 col-md-4 col-sm-4 col-12">
            <input type="number" class="form-control" name="phone" placeholder="Contract Number">
        </div>
        <div class="input-group mb-2 col-md-3 col-sm-3 col-12">
            <select class="form-control" name="code" placeholder="">
