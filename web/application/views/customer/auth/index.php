            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <span class="alert-inner--text">incorrect phone number & password</span>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <?php endif?>
                <small>Sign in with the registered phone number and password</small>
              </div>
              <form role="form" method="post" action="<?=base_url()?>login/post">
              <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-mobile-alt"></i></span>
                    </div>
                    <input class="form-control" placeholder="Phone Number or Email" type="text" name="phone" required>
                  </div>
                </div>
                ...
                <div class="text-center">
                  ...
                  <a href="<?=base_url()?>register" name="register">Register</a>
                </div>
                <div class="text-center">
                  <a href="<?=base_url()?>forgot-password"><small class="text-muted"><i>forgot password?</i></small></a>
                </div>
              </form>
            </div>
          </div>
