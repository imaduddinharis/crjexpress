          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                ...
                <?php endif?>
                <?php if($this->session->userdata('ACCOUNT_INVALID')):?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <span class="alert-inner--text">Please correctly input your phone number and email</span>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
              ...
              <form role="form" method="post" action="<?=base_url()?>forgot-password/post">
                ...
                <div class="text-center">
                  <button type="submit" name="forgot" class="btn btn-primary my-4">Submit</button>
                  <a href="<?=base_url()?>login" name="register">Sign In</a>
                </div>
              </form>
            </div>
          </div>
